...
export class SeedService implements OnModuleInit {
  ...
  constructor(
    ...
    private tipoProyectoModel: Model<TipoProyectoDocument>,
      ...
      const tipos = [
        {
          ...
          descripcion: 'Proyectos de desarrollo de software',
        },
        {
          nombre: 'MARKETING',
          descripcion: 'Proyectos de marketing y publicidad',
        },
  ...
  private async seedEstadoProyecto() {
    ...
    if (count === 0) {
      const estados = [
        ...
        {
          nombre: 'PAUSADO',
          descripcion: 'El proyecto está detenido temporalmente',
        },
