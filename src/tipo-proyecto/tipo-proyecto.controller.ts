...
export class TipoProyectoController {
    ...
    @ApiResponse({ status: 201, description: 'The TipoProyecto has been successfully created.' })
    ...
    @ApiResponse({ status: 200, description: 'The TipoProyecto has been successfully updated.' })
    @ApiResponse({ status: 404, description: 'TipoProyecto not found.' })
    ...
    @ApiResponse({ status: 200, description: 'The TipoProyecto has been successfully deleted.' })
    @ApiResponse({ status: 404, description: 'TipoProyecto not found.' })
