...
export class EstadoProyectoController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The EstadoProyecto has been successfully created.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The EstadoProyecto has been successfully updated.',
  })
  @ApiResponse({ status: 404, description: 'EstadoProyecto not found.' })
  update(
    @Param('id') id: string,
    @Body() updateEstadoProyectoDto: UpdateEstadoProyectoDto,
  ) {
  ...
  @ApiResponse({
    status: 200,
    description: 'The EstadoProyecto has been successfully deleted.',
  })
  @ApiResponse({ status: 404, description: 'EstadoProyecto not found.' })
