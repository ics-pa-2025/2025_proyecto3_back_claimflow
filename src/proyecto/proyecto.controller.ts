...
export class ProyectoController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The Proyecto has been successfully created.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The Proyecto has been successfully updated.',
  })
  @ApiResponse({ status: 404, description: 'Proyecto not found.' })
  update(
    @Param('id') id: string,
  ...
  @ApiResponse({
    status: 200,
    description: 'The Proyecto has been successfully deleted.',
  })
  @ApiResponse({ status: 404, description: 'Proyecto not found.' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Return all Reclamos for the Proyecto.',
  })
  @ApiResponse({ status: 404, description: 'Proyecto not found.' })
  ...
  @ApiResponse({
    status: 200,
    description: 'The Proyecto state has been successfully updated.',
  })
  @ApiResponse({ status: 404, description: 'Proyecto not found.' })
